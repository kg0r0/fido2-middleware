...
mocha_1.describe("assertionResultReqValidator()", function () {
    ...
    mocha_1.describe("isConfigFile()", function () {
        mocha_1.it("should return true", function () {
            return chai_1.expect(util_1.isConfigFile(process.cwd())).to.equal(true);
        });
        mocha_1.it("should return false", function () {
            return chai_1.expect(util_1.isConfigFile("Invalid File Path")).to.equal(false);
        });
    });
});
