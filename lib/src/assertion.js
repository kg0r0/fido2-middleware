...
function assertionResult(req) {
    return __awaiter(this, void 0, void 0, function () {
        var clientData, validateClientDataResult, authenticators, cacheData, authr, fido2Lib, expected, requestBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    validateClientDataResult = util_1.assertionClientDataJSONValidater(req, clientData);
                    if (validateClientDataResult.status === "failed") {
                        return [2 /*return*/, validateClientDataResult];
                    }
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fido2Lib.assertionResult(requestBody, expected).catch(function (err) {
                            return {
                                status: "failed",
