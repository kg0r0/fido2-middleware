...
function assertionOptions(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var authenticators, allowCredentials, _i, authenticators_1, authr, serve, options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    allowCredentials = [];
                    for (_i = 0, authenticators_1 = authenticators; _i < authenticators_1.length; _i++) {
                        authr = authenticators_1[_i];
                        console.log(authr.credID);
