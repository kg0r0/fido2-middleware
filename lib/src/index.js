...
function attestationResult(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var errorMessage, isBase64Url, fido2Lib, expected, requestBody, result, authrInfo, cacheData, authenticators, obj;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        isBase64Url = util_1.isBase64UrlEncoded(req.body.id);
                    }
                    catch (e) {
...
function assertionResult(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var errorMessage, isBase64Url, clientData, authenticators, cacheData, authr, fido2Lib, expected, requestBody, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(req.body != null && util_1.isRequestBody(req.body))) {
