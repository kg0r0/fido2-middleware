...
var fido2MiddlewareConfig = config.get("fido2-middlewareConfig");
/**
 *
 * @param len
 */
function randomBase64URLBuffer(len) {
    len = len || 32;
    var buff = crypto.randomBytes(len);
 ...
 * @return {Boolean}
 */
function isBase64UrlEncoded(b64UrlString) {
 ...
 * @returns {undefined}
 */
function attestationResult(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var fido2Lib, expected, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!req.body ||
