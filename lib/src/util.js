...
function isRequestBody(bodyObject) {
    return (bodyObject.id != null && bodyObject.rawId != null && bodyObject.response != null && bodyObject.type != null);
}
 ...
 * @param {Object}
 */
function assertionClientDataJSONValidater(req, clientDataJSON) {
...
exports.assertionClientDataJSONValidater = assertionClientDataJSONValidater;
